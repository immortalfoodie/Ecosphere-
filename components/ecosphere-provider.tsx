...
const seedState: EcosphereState = {
  ...
  scannerProducts: [
    ...
    {
      id: "3",
      name: "Peanut Chikki Minis",
      brand: "National Chikki Snacks",
      barcode: "8906040481163",
      ecoScore: 65,
      carbonFootprint: "0.42 kg CO₂",
      waterUsage: "120L",
      recyclable: false,
      certifications: ["Plant-Based", "Low Carbon", "Traditional"],
      description: "Plant-based snack (200g). Carbon Level: Low–Medium. Ingredients: Peanuts (low impact, nitrogen-fixing crop) + Jaggery (minimally processed). Packaging: Single-use plastic (non-recyclable). Aligns with SDG 12 (Responsible Consumption), SDG 13 (Climate Action), SDG 15 (Life on Land).",
      alternatives: ["Chikki in paper packaging", "Homemade peanut bars", "Bulk store options"],
    },
    {
      id: "4",
      name: "Bisleri Water 250ml",
      brand: "Bisleri",
      barcode: "8901262010009",
      ecoScore: 38,
      carbonFootprint: "0.11 kg CO₂",
      waterUsage: "1.5L",
      recyclable: true,
      certifications: [],
      description: "Packaged drinking water (250ml). Carbon Level: Medium. PET plastic bottle - recyclable but high impact if not recycled. Groundwater extraction. SDG 6, 12, 13 aligned. Tip: Prefer refillable bottles.",
      alternatives: ["Reusable Steel Bottle", "Glass Water Bottle", "Filtered Tap Water"],
    },
    {
      id: "5",
      name: "Bisleri Water 500ml",
      brand: "Bisleri",
      barcode: "8901262150002",
      ecoScore: 35,
      carbonFootprint: "0.18 kg CO₂",
      waterUsage: "2.5L",
      recyclable: true,
      certifications: [],
      description: "Packaged drinking water (500ml). Carbon Level: Medium. PET plastic bottle - recyclable. Higher volume = slightly better per-ml efficiency but still significant plastic waste. SDG 6, 12, 13 aligned.",
      alternatives: ["Reusable Steel Bottle", "Glass Water Bottle", "Filtered Tap Water"],
    },
    {
      id: "6",
      name: "Bisleri Water 1 Litre",
      brand: "Bisleri",
      barcode: "8901262011006",
      ecoScore: 32,
      carbonFootprint: "0.28 kg CO₂",
      waterUsage: "4L",
      recyclable: true,
      certifications: [],
      description: "Packaged drinking water (1L). Carbon Level: Medium-High. Larger PET bottle - recyclable. Better per-litre efficiency but significant single-use plastic. Consider reusable alternatives. SDG 6, 12, 13 aligned.",
      alternatives: ["1L Reusable Bottle", "Water Filter at Home", "Glass Bottles"],
    },
    {
      id: "7",
      name: "Bisleri Water 2 Litre",
      brand: "Bisleri",
      barcode: "8901262012003",
      ecoScore: 30,
      carbonFootprint: "0.45 kg CO₂",
      waterUsage: "6L",
      recyclable: true,
      certifications: [],
      description: "Packaged drinking water (2L). Carbon Level: High. Large PET bottle - recyclable but heavy plastic use. Best per-litre efficiency among bottles but home water filter is far better. SDG 6, 12, 13 aligned.",
      alternatives: ["Home Water Filter", "20L Water Can", "Copper Water Storage"],
    },
  ],
  scanHistory: [],
  storeProducts: [
